...
func waitForPod(podClient coreclient.PodsGetter, ns, name string, exitCondition wuntil.ConditionFunc) (*api.Pod, error) {
	...
	err = intr.Run(func() error {
		...
		ev, err := wuntil.UntilWithInformer(0, lw, &api.Pod{}, 0, func(ev watch.Event) (bool, error) {
